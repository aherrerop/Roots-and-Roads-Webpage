...
console.log('--- Guide passwords: plaintext verify (hashing was reverted) ---');
check('the right password verifies', verifyPassword_('titaGorda22', 'titaGorda22') === true, null);
check('a wrong password does NOT verify', verifyPassword_('titaGorda22', 'nope') === false, null);
check('empty stored never authenticates', verifyPassword_('', '') === false && verifyPassword_(null, '') === false, null);
check('a blank submitted password never authenticates', verifyPassword_('HolaMar', '') === false, null);
